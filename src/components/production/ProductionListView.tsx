    ...
    <div className="bg-white rounded-2xl border-2 border-black shadow-neo-active overflow-hidden">
      <div className="overflow-x-auto">
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-slate-50 text-black border-y-2 border-black">
              <th className="px-6 py-4 text-[10px] font-black uppercase tracking-widest border-r border-black/10">SKU / Sản phẩm</th>
              <th className="px-6 py-4 text-[10px] font-black uppercase tracking-widest border-r border-black/10">Mã đơn</th>
              <th className="px-6 py-4 text-[10px] font-black uppercase tracking-widest border-r border-black/10">Khách hàng</th>
              <th className="px-6 py-4 text-[10px] font-black uppercase tracking-widest border-r border-black/10 text-center">Sản lượng</th>
              <th className="px-6 py-4 text-[10px] font-black uppercase tracking-widest border-r border-black/10">Tiến độ</th>
              <th className="px-6 py-4 text-[10px] font-black uppercase tracking-widest border-r border-black/10">Hạn SX</th>
              <th className="px-6 py-4 text-[10px] font-black uppercase tracking-widest border-r border-black/10">Vị trí</th>
              <th className="px-6 py-4 text-[10px] font-black uppercase tracking-widest border-r border-black/10">Ưu tiên</th>
                ...
                >
                  <td className="px-6 py-5 border-r border-black/5">
                    <div className="flex flex-col gap-1">
                      ...
                      <span className="text-sm font-bold text-black line-clamp-1 italic">{order.title}</span>
                    </div>
                  </td>
                  <td className="px-6 py-5 border-r border-black/5">
                    <span 
                  ...
                  <td className="px-6 py-5 border-r border-black/5 text-center">
                  ...
                  <td className="px-6 py-5 border-r border-black/5">
                    <div className="flex items-center gap-4 w-full max-w-[240px]">
                      <div className="flex-1 h-2.5 bg-gray-100 rounded-full overflow-hidden border border-black/5 shadow-inner">
                        <div 
                          className={cn(
                      ...
                      <span className="text-[10px] font-black text-primary italic shrink-0 min-w-[32px]">{order.progress}%</span>
                    </div>
                  </td>
                  <td className="px-6 py-5 border-r border-black/5">
                    <div className="flex items-center gap-2 text-xs font-bold text-neo-blue italic" title="Hạn hoàn thành SX">
                      <Clock size={14} className="text-neo-blue/40" />
                  ...
                  <td className="px-6 py-5">
                    <div className="flex items-center gap-2">
                      <div className={`inline-flex items-center gap-2 px-3 py-1.5 rounded-xl border-2 border-black/5 text-[10px] font-black uppercase tracking-widest ${status.color}`}>
